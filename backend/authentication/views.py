from rest_framework import generics, serializers, status, filters, pagination, views
...
from backend.settings import DATETIME_FORMAT
...
class MyProfileAPIView(views.APIView):
    ...
    def get(self, request):
        if request.user.is_anonymous:
            return Response({'message': 'Обліковий запис не зареєстрований'})
        
        return Response({'profile': request.user.username})
